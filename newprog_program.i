...
# 3 "newprog_program.c" 2


# 4 "newprog_program.c"
int main(void) {
    char *newprog_args[] = { "Tee-hee!", "newprog_arg1", "newprog_arg2", 
# 5 "newprog_program.c" 3 4
                                                                        ((void *)0) 
# 5 "newprog_program.c"
                                                                             };
    char *newprog_envp[] = { "USER=abrakadabra", "HOME=/home/abrakadabra", 
# 6 "newprog_program.c" 3 4
                                                                          ((void *)0) 
# 6 "newprog_program.c"
                                                                               };
    ...
    fprintf(
# 10 "newprog_program.c" 3 4
           stderr
# 10 "newprog_program.c"
                 , "Error\n");
    return 0;
}
