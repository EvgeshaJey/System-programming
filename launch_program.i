...
# 3 "launch_program.c" 2


# 4 "launch_program.c"
int main(void) {

    char *browser_args[] = { "firefox", 
# 6 "launch_program.c" 3 4
                                       ((void *)0) 
# 6 "launch_program.c"
                                            };
    char *editor_args[] = { "gedit", 
# 7 "launch_program.c" 3 4
                                    ((void *)0) 
# 7 "launch_program.c"
                                         };
    ...
    if (browser_pid == 0) {
        execve("/usr/bin/firefox", browser_args, 
# 11 "launch_program.c" 3 4
                                                ((void *)0)
# 11 "launch_program.c"
                                                    );
        fprintf(
# 12 "launch_program.c" 3 4
               stderr
# 12 "launch_program.c"
    ...
    if (editor_pid == 0) {
        execve("/usr/bin/gedit", editor_args, 
# 18 "launch_program.c" 3 4
                                             ((void *)0)
# 18 "launch_program.c"
                                                 );
        fprintf(
# 19 "launch_program.c" 3 4
               stderr
# 19 "launch_program.c"
